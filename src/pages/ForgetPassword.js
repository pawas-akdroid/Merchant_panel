...
import { MerchantUrl } from '../Utilities/Urls';
...
const ForgetPart = ({ setPhone, log_phone, setMode }) => {
  ...
  const handleLogin = (e) => {
    ...
    MerchantUrl.post(`/forget-password`, body).then((res) => {
  ...
  const handleOtp = (e) => {
    ...
    MerchantUrl.post(`/reset-password/${log_phone}`, body).then((res) => {
  ...
  const ResendOtp = (e) => {
    MerchantUrl.post(`/resend-login-code/${log_phone}`).then((res) => {
...
const ChangePassword = ({ log_phone }) => {
  ...
  const handleChangePassword = (e) => {
    e.preventDefault()
    MerchantUrl.post(`/new-password/${log_phone}`, { password: password }).then(res => {
